"""
ce fichier correspond a l'implementation du conditionnal gan qui permet de generer les images par label marque
"""
...
if __name__ == '__main__':
    ...
    SAMPLE_SIZE = 80
    NUM_LABELS = 30
    train_dataset = datasets.ImageFolder(root='new_data',
    ...
    one_hot_labels = torch.FloatTensor(args.batch_size, 30)
    ...
    for epoch_idx in range(args.epochs):
        ...
        for batch_idx, (train_x, train_y) in enumerate(train_loader):
            ...
            print("HEHEHE")
            print(train_y.view(batch_size,1))
