...
## general settings.
parser.add_argument('--train_data_root', type=str, default='workbitch/work_ff_pggan/data')
parser.add_argument('--csv_file', type=str, default='workbitch/work_ff_pggan/ff_file.csv') #csv file which stores all encodings
...
parser.add_argument('--start_res', type=int, default=6)
parser.add_argument('--checkpoint_generator', type=str, default="gen_R6_T2950.pth.tar")
parser.add_argument('--checkpoint_discriminator', type=str, default="dis_R6_T2950.pth.tar")
...
parser.add_argument('--nz', type=int, default=144)              # input dimension of noise.
